export default function ActiveTabToggle({ activeTab, setActiveTab }) {
  return (
    <div className="relative flex bg-gray-100 p-1 rounded-full w-[200px] sm:w-[250px]">
      ...
      {['Guest', 'Restaurant'].map((tab) => (
        <button
          ...
          className={`relative z-10 flex-1 py-2 sm:py-2.5 rounded-full text-[12px] sm:text-md font-bold tracking-wide transition-colors duration-300 text-center ${
